...
\includegraphics[width=0.9\linewidth]{Profile_KHM_files/figure-latex/unnamed-chunk-1-1}

\hypertarget{tb-prevalence-survey-data}{%
\subsection{TB prevalence survey data}\label{tb-prevalence-survey-data}}

\includegraphics[width=0.9\linewidth]{Profile_KHM_files/figure-latex/unnamed-chunk-2-1}
...
\includegraphics[width=0.9\linewidth]{Profile_KHM_files/figure-latex/unnamed-chunk-3-1}
...
\includegraphics[width=0.9\linewidth]{Profile_KHM_files/figure-latex/unnamed-chunk-4-1}

\hypertarget{time-spent}{%
\subsection{Time-spent}\label{time-spent}}

\includegraphics[width=0.9\linewidth]{Profile_KHM_files/figure-latex/unnamed-chunk-5-1}

\hypertarget{time-spent-by-sex}{%
\subsection{Time-spent by sex}\label{time-spent-by-sex}}

\includegraphics[width=0.9\linewidth]{Profile_KHM_files/figure-latex/unnamed-chunk-6-1}
...
\includegraphics[width=0.9\linewidth]{Profile_KHM_files/figure-latex/unnamed-chunk-7-1}
