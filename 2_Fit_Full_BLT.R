...
save(fitted1, fitted2, fitted3, dataset, file = "output/Full/BLT/Total.rdata")
...
save(fitted0, fitted1, fitted2, fitted3, dataset, file = "output/Full/BLT/Age.rdata")
...
save(fitted0, fitted1, fitted2, fitted3, dataset, file = "output/Full/BLT/Sex.rdata")
...
save(fitted0, fitted1, fitted2, fitted3, dataset, file = "output/Full/BLT/HIV.rdata")
...
save(fitted_full, dataset, file = "output/Full/BLT/Cov.rdata")
