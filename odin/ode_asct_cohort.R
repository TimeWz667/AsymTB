...
deriv(Tr) <- r_det * C - (r_death_ontr + r_death_bg + r_cure + r_ltfu) * Tr
deriv(LTFU) <- r_ltfu * Tr
deriv(Death) <- r_death_bg * (A + S + C + Tr) + r_death_untr * (S + C) + r_death_ontr * Tr
...
ga_a <- r_sc + r_death_bg
ga_s <- r_sc + r_death_bg + r_death_untr
ga_c <- r_sc + r_death_bg + r_death_untr
